...
3.  **Smart Gatekeeping ($0 Cost Mode):** The Image and Video nodes feature "Gatekeeper Logic." If you are just chatting with the Agent (e.g., "How are you?"), the generators receive empty prompts and "sleep" instantly, incurring **zero cost**.
